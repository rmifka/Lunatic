...
public partial class MainWindowViewModel : ViewModelBase
{
    ...
    private async Task Browse()
    {
        ...
        if (!string.IsNullOrWhiteSpace(result))
        {
            ...
            CheckIfLunaticInstalled(result);
        }
    }
    ...
    public void InstallCommand()
    {
        ...
        try
        {
            ...
            var bootstrapperPath = Path.Combine(managedPath, "Lunatic.Bootstrapper.dll");
            var loaderPath = Path.Combine(managedPath, "Lunatic.Loader.dll");
            var publicPath = Path.Combine(managedPath, "Lunatic.Public.dll");
            ...
            Status = "Lunatic successfully installed!";
        }
        catch (Exception ex)
        {
    ...
    {
        var sourceBootstrapper = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources", "Lunatic.Bootstrapper.dll");
    ...
    {
        var sourceBootstrapper = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources", "Lunatic.Loader.dll");
        File.Copy(sourceBootstrapper, bootstrapperPath, true);
        Status = "Bootstrapper copied.";
    }
    ...
    {
        var sourceBootstrapper = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources", "Lunatic.Public.dll");
        File.Copy(sourceBootstrapper, bootstrapperPath, true);
        Status = "Bootstrapper copied.";
    }
    ...
    private void OpenGitHub()
    {
        ...
        {
            FileName = "https://github.com/rmifka/Lunatic",
    ...
    private void About()
    {
        AppendLog("Lunatic Mod Loader Installer. Made with ❤️ and SukiUI.");
    }
    ...
    private void CheckIfLunaticInstalled(string path)
    {
